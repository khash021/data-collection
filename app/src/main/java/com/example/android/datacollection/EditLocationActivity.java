...
public class EditLocationActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
            ...
            public void onClick(View v) {
                    if ((mEstablishmentCheckBox.isChecked() &&
                        ...
                        if (result) {
                            ...
                            Toast.makeText(EditLocationActivity.this, "Error with updating",
                                    Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(EditLocationActivity.this, "If the establishment" +
